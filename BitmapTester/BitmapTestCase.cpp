...
void testIndexOf3()
{
	...
	Bitmap bitmap(_T("..\\TestResources\\Lena.bmp"));
	CPPUNIT_ASSERT( sub.GetPixel(0,0)==bitmap.GetPixel(122,251) );
	CPPUNIT_ASSERT( sub.GetPixel(27,0)==bitmap.GetPixel(149,251) );
	CPPUNIT_ASSERT( sub.GetPixel(0,1)==bitmap.GetPixel(122,252) );
